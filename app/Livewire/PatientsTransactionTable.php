...
class PatientsTransactionTable extends Component
{
    public $patientId;
    ...
    public function render()
    {
        $transactions = ClinicTransactions::with([
            ...
            ->where('patient_id', $this->patientId) // 🔥 only this patient
        ...
        return view('livewire.patients-transaction-table', compact('transactions'));
    }
}
