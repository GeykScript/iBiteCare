...
class BoosterRegistration extends Controller
{
    ...
    public function registerPatientBooster(RegisterPatientBoosterRequest $request){
        ...
        try {
            ...
            Log::error('Error registering Booster patient: ' . $e->getMessage(), [
                'stack' => $e->getTraceAsString()
            ]);
            $id = $request->service_id;
            return redirect()->route('clinic.patients.register.booster', ['id' => $id])->with('error', 'An error occurred while processing your request.');
        }
