...
class BoosterTransaction extends Controller
{
    public function showForm($service_id, $patient_id)
    {
        ...
        $boosterService = $service_id;

        return view('ClinicUser.Transactions.new-booster', compact('clinicUser', 'pvrvVaccines', 'pcecVaccines', 'nurses', 'staffs', 'patient', 'service_fee', 'boosterService'));
    }

    public function addBoosterTransaction(PrepTransactionRequest $request){
        $request->validated();
