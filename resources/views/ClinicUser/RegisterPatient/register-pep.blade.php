...
<script>
    ...
    function validateStep(step) {
        ...
        const inputs = currentStepElement.querySelectorAll("input[type='text'], input[type='date'], select");
        let isValid = true;
        ...
        // Validate hidden location fields separately
        const locationFields = [{
            ...
            {
                input: "barangay_input",
                wrapper: "barangay_wrapper"
            }
        ];
