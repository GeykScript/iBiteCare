                ...
                <div class="grid grid-cols-4  md:px-10 h-full mb-10 gap-2 ">
                    <div class="col-span-4 bg-white rounded-lg shadow-lg w-full  px-10 py-4  border border-gray-100">
                        ...
                        <form id="multi-step-form" method="POST" action="{{ route('clinic.patients.register.prep.register') }}">
                            ...
                            <x-prep-steps.step-1 :emails="$emails" />
                            ...
                            <div class="flex justify-end mt-6 gap-4">
                                ...
                                <button type="submit" id="submitPrepBtn" class="px-4 py-2 bg-sky-500 text-white rounded-lg hover:bg-sky-600 focus:outline-none focus:shadow-outline hidden">Submit</button>
                            </div>
                        </form>
...
<script>
    ...
    const submitPrepBtn = document.getElementById("submitPrepBtn");
    ...
    function showStep(step) {
        ...
        submitPrepBtn.classList.toggle("hidden", step !== totalSteps);
    }
