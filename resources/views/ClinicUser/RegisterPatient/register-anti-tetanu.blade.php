                    ...
                    <div class="col-span-4 bg-white rounded-lg shadow-lg w-full  px-10 py-4  border border-gray-100">
                        ...
                        <form id="multi-step-form" method="POST" action="{{ route('clinic.patients.register.anti-tetanus.register') }}">
                            ...
                            <div class="flex justify-end mt-6 gap-4">
                                ...
                                <button type="button" id="nextBtn" class="px-8 py-2 bg-sky-500 text-white rounded-lg hover:bg-sky-600 focus:outline-none focus:shadow-outline">
                                    Next</button>
                                <button type="submit" id="submitAntiBtn" class="px-4 py-2 bg-sky-500 text-white rounded-lg hover:bg-sky-600 focus:outline-none focus:shadow-outline hidden">Submit</button>
                            </div>
                        </form>
...
<script>
    ...
    const submitAntiBtn = document.getElementById("submitAntiBtn");
    ...
    function showStep(step) {
        ...
        submitAntiBtn.classList.toggle("hidden", step !== totalSteps);
    }
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (validateStep(3)) {
            submitAntiBtn.disabled = true;

            // Show overlay
            document.getElementById("overlay").classList.remove("hidden");

            // Optional: change button text too
            submitAntiBtn.innerHTML = `
