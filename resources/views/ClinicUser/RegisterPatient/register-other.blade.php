            ...
            <div class="flex flex-col flex-1  pt-[60px]">
                ...
                <div class="grid grid-cols-4  md:px-10 gap-2 ">
                    <div class="col-span-4 bg-white rounded-lg shadow-lg w-full  px-10 py-4  border border-gray-100">
                        <div class="flex flex-col gap-4 md:gap-0 ">
                            ...
                            <div class="flex flex-col mb-6 ">
                                ...
                                <div class="flex items-center justify-center gap-2">
                                    <p class="text-gray-400 text-sm text-center">Service: {{ $services->name }}</p>
                        ...
                        <!-- Form Steps -->
                        <form id="multi-step-form" method="POST" action="{{ route('clinic.patients.register.other.register') }}">
                            @csrf
                            ...
                            <x-other-steps.step-1 :emails="$emails" />
                            ...
                            <div class="flex justify-end mt-6 gap-4">
                                ...
                                <button type="submit" id="submitOtherBtn" class="px-4 py-2 bg-sky-500 text-white rounded-lg hover:bg-sky-600 focus:outline-none focus:shadow-outline hidden">Submit</button>
                            </div>
                        </form>
                        ...
                        <dialog
                            ...
                            x-ref="modal"
                            @other-payment-modal.window="staff_id = $event.detail.staff_id; staff_name = $event.detail.staff_name; open()"
                                ...
                                @submit.prevent="
                                            ...
                                            .then(data => {
                                                if (data.success) {
                                                    ...
                                                    document.querySelector('#staffDropdownButton').classList.add('border-red-500', 'bg-white', 'focus:border-red-500', 'focus:ring-red-500');
                        ...
                        <dialog
                            ...
                            x-ref="modal"
                            @other-nurse-modal.window="nurse_id = $event.detail.nurse_id; nurse_name = $event.detail.nurse_name; open()"
                            class="p-8 rounded-lg shadow-lg w-full max-w-xl backdrop:bg-black/30 focus:outline-none">
...
<script>
    ...
    function showStep(step) {
        ...
        submitOtherBtn.classList.toggle("hidden", step !== totalSteps);
    }
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (validateStep(3)) {
            ...
            submitOtherBtn.disabled = true;

            // Show overlay
            document.getElementById("overlay").classList.remove("hidden");

            // Optional: change button text too
            submitOtherBtn.innerHTML = `
