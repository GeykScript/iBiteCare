            ...
            <div class="flex flex-col flex-1  pt-[60px]">
                <div class="flex flex-row items-center md:gap-5 gap-3 py-8 md:px-14 px-4">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <p class="font-bold text-red-500">New {{ $services->name }} Immunization</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-4  md:px-10 gap-2 ">
                    <div class="col-span-4 bg-white rounded-lg shadow-lg w-full  px-10 py-4  border border-gray-100">
                        ...
                        <!-- Form Steps -->
                        <form id="multi-step-form" method="POST" action="{{ route('clinic.patients.new-transaction.other.add') }}">
                            @csrf
                            ...
                            <div class="flex justify-end mt-6 gap-4">
                                ...
                                <button type="submit" id="submitNewOtherBtn" class="px-4 py-2 bg-sky-500 text-white rounded-lg hover:bg-sky-600 focus:outline-none focus:shadow-outline hidden">Submit</button>
                            </div>
                        </form>
...
<script>
    ...
    const submitNewOtherBtn = document.getElementById("submitNewOtherBtn");
    ...
    function showStep(step) {
        ...
        submitNewOtherBtn.classList.toggle("hidden", step !== totalSteps);
    }
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (validateStep(3)) {
            ...
            submitNewOtherBtn.disabled = true;

            // Show overlay
            document.getElementById("overlay").classList.remove("hidden");

            // Optional: change button text too
            submitNewOtherBtn.innerHTML = `
