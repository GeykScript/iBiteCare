                    ...
                    <div class="col-span-4 bg-white rounded-lg shadow-lg w-full  px-10 py-4  border border-gray-100">
                        <div class="flex flex-col gap-4 l:gap-0 ">
                            ...
                            <div class="flex flex-col mb-6 ">
                                <h1 class="text-l  l:text-2xl font-900 text-center ">New Patient Transaction</h1>
                        ...
                        <!-- Form Steps -->
                        <form id="multi-step-form" method="POST" action="{{ route('clinic.patients.new-transaction.prep.add') }}">
                            @csrf
                            ...
                            <div class="flex justify-end mt-6 gap-4">
                                ...
                                <button type="submit" id="submitNewPrepBtn" class="px-4 py-2 bg-sky-500 text-white rounded-lg hover:bg-sky-600 focus:outline-none focus:shadow-outline hidden">Submit</button>
                            </div>
                        </form>
...
<script>
    ...
    const submitNewPrepBtn = document.getElementById("submitNewPrepBtn");
    ...
    function showStep(step) {
        ...
        submitNewPrepBtn.classList.toggle("hidden", step !== totalSteps);
    }
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (validateStep(3)) {
            ...
            submitNewPrepBtn.disabled = true;

            // Show overlay
            document.getElementById("overlay").classList.remove("hidden");

            // Optional: change button text too
            submitNewPrepBtn.innerHTML = `
