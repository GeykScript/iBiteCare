            ...
            <div class="flex flex-col flex-1  pt-[60px]">
                <div class="flex flex-row items-center md:gap-5 gap-3 py-8 md:px-14 px-4">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <p class="font-bold text-red-500">New PEP Immunization</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-4  md:px-10 h-full mb-10 gap-2 ">
                    <div class="col-span-4 bg-white rounded-lg shadow-lg w-full  px-10 py-4  border border-gray-100">
                        ...
                        <div class="mb-8 overflow-x-auto  scrollbar-hidden ">
                            <div class="flex items-center justify-between min-w-[400px] md:min-w-full flex-nowrap">
                                ...
                                <div class="flex flex-col items-center ">
                                    ...
                                    <span class="mt-2 text-xs md:text-sm font-bold text-gray-900 text-center">History Exposure</span>
                                </div>
                        ...
                        <!-- Form Steps -->
                        <form id="multi-step-form" method="POST" action="{{ route('clinic.patients.new-transaction.pep.add')}}">
                            @csrf
                            ...
                            <div class="l:w-full grid grid-cols-6 gap-2 l:px-6 mb-6" id="vital-signs">
                                <div class="col-span-6 ">
                                    <h2 class="l:text-lg text-gray-600 font-900">Vital Signs </h2>
                                </div>
                                <div class="col-span-6 sm:col-span-2 l:col-span-1 ">
                            ...
                            <div class="flex justify-end mt-6 gap-4">
                                ...
                                <button type="submit" id="submitNewPepBtn" class="px-4 py-2 bg-sky-500 text-white rounded-lg hover:bg-sky-600 focus:outline-none focus:shadow-outline hidden">Submit</button>
                            </div>
                        </form>
...
<script>
    ...
    const submitNewPepBtn = document.getElementById("submitNewPepBtn");
    ...
    function showStep(step) {
        ...
        submitNewPepBtn.classList.toggle("hidden", step !== totalSteps);
    }
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (validateStep(5)) {
            ...
            submitNewPepBtn.disabled = true;

            // Show overlay
            document.getElementById("overlay").classList.remove("hidden");

            // Optional: change button text too
            submitNewPepBtn.innerHTML = `
