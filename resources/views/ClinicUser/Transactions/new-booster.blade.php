                    ...
                    <div class="col-span-4 bg-white rounded-lg shadow-lg w-full  px-10 py-4  border border-gray-100">
                        ...
                        <form id="multi-step-form" method="POST" action="{{ route('clinic.patients.new-transaction.booster.add') }}">
                            ...
                            <div class="flex justify-end mt-6 gap-4">
                                ...
                                <button type="submit" id="submitNewBoosterBtn" class="px-4 py-2 bg-sky-500 text-white rounded-lg hover:bg-sky-600 focus:outline-none focus:shadow-outline hidden">Submit</button>
                            </div>
                        </form>
...
<script>
    ...
    const submitNewBoosterBtn = document.getElementById("submitNewBoosterBtn");
    ...
    function showStep(step) {
        ...
        submitNewBoosterBtn.classList.toggle("hidden", step !== totalSteps);
    }
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (validateStep(3)) {
            ...
            submitNewBoosterBtn.disabled = true;

            // Show overlay
            document.getElementById("overlay").classList.remove("hidden");

            // Optional: change button text too
            submitNewBoosterBtn.innerHTML = `
