        ...
        <section id="mainContent" class="flex-1 ml-0 md:ml-56 h-full   ">
            ...
            <div class="flex flex-col flex-1  pt-[60px]">
                <div class="flex flex-row items-center gap-5 py-6 md:py-8 md:px-14 px-4">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <a href="{{ route('clinic.user-manual') }}#payments" target="_blank" class="text-[#FF000D]"> <i data-lucide="circle-question-mark" class="w-5 h-5"></i></a>
                        </div>
                ...
                <div class="grid grid-cols-4 p-4 md:px-10">
                    <div class="col-span-4 bg-white rounded-lg border border-gray-200 shadow-md p-4">
