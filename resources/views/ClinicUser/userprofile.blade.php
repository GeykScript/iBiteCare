        ...
        <div class="side-bar w-56 fixed inset-y-0 bg-white text-black flex flex-col border-r border-gray-300 h-screen z-50 hidden " id="sidebar">
            ...
            <nav class="flex-1 overflow-y-auto min-h-0 px-4 md:py-6 py-0 text-md scrollbar-hidden mt-20 md:mt-0">
                <ul class="space-y-3">
                    ...
                    <li><a href="{{ route('clinic.patients') }}" class="block px-4 py-2 rounded bg-gray-800 text-white flex items-center gap-3"><i data-lucide="users" class="w-5 h-5"></i>Patients</a></li>
        ...
        <section id="mainContent" class="flex-1  h-full  ">
            ...
            <div class="flex flex-col flex-1  pt-[60px]">
                <div class="flex flex-row items-center gap-5 py-8 px-14">
                    ...
                    <div>
                        <h1 class="text-2xl md:text-3xl font-900">Manage Clinic Account</h1>
                        <h2 class="ml-3 text-lg font-bold">Clinic Personal Information</h2>

                    </div>
                </div>
                <!-- Header content -->
                <div class="flex items-center md:gap-2 px-20">
                    <h2 class="ml-3 text-lg p-4">To enhance the security of your account, it is important to change the default password immediately after your first login. We also strongly recommend setting up security questions to help you recover your account in case you forget your password.</h2>
