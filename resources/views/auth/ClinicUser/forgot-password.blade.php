        ...
        <div class="flex flex-col md:flex-row justify-center items-center ">
            ...
            <div class="md:h-[37.5rem] bg-white md:w-[38rem]  w-[20rem] h-[30rem] md:rounded-r-[15px] rounded-b-[10px] md:rounded-b-[0px] shadow-lg items-center justify-center p-5 md:p-20">
                ...
                <div class="flex flex-col justify-center ">
                    ...
                    <form method="POST" action="{{ route('clinic.two-factor.send_code') }}" class="mt-5">
                        @csrf
                        ...
                        <div class="mt-6">
                            ...
                            <x-input-error :messages="$errors->get('account_id')" class="bg-red-200 px-4 py-2 mt-2 rounded-sm" />
                        </div>
