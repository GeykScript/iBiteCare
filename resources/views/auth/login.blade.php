                    ...
                    <div class="flex flex-col justify-center gap-4">
                        ...
                        <div class="flex flex-col justify-between md:px-12">
                            ...
                            <div class="flex flex-col">
                                <form method="POST" action="{{ route('login') }}" id="loginFormPatient">
                                    @csrf
                                    <!-- Email Address -->
                                    <div class="mt-2">
                                    ...
                                    <div class="mt-4">
                                        <x-primary-button id="submitBtn" class="w-full justify-center bg-red-600 hover:bg-red-700 focus:bg-red-700">
                                            {{ __('Log in') }}
                                        </x-primary-button>
                                    </div>
...
<script>
    ...
    document.getElementById('loginFormPatient').addEventListener('submit', function() {
