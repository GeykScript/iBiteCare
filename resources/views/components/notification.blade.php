 ...
 <div x-data="notificationsComponent()" class="relative hover:cursor-pointer">
     ...
     <div @click="toggleDropdown()">
         ...
         <span  x-show="hasUnread" x-cloak class="absolute top-0.5 right-0 block h-2 w-2 rounded-full bg-red-600"></span>
     </div>

     <!-- Notification Dropdown -->
     <div x-cloak
          x-show="open" x-transition @click.outside="closeDropdown()"
