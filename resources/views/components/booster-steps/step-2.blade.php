    ...
    <div class="flex flex-col gap-2">
        <div class="grid grid-cols-12 gap-2">
            ...
            <div class="col-span-12  md:px-4">
                <h2 class="md:text-lg text-gray-700 font-900 mb-2 text-center">Booster Vaccination</h2>
                    ...
                    <div class=" items-center">
                        <div class="flex flex-col">
                            <div class="grid grid-cols-12 gap-2">
                                ...
                                <div class="col-span-12 md:col-span-5 md:px-4">
                                ...
                                <div class="col-span-12 md:col-span-3 md:px-4 ">
                                    ...
                                    <div class="flex gap-2 "
                                        ...
                                        <div class="flex flex-col ">
                                            ...
                                            <button
                                                ...
                                                type="button"
                                                :disabled="!nurse_id"
                                                @click="$dispatch('booster-nurse-modal', { nurse_id: nurse_id, nurse_name: nurse_name })"
