<div id="step-4" class="step hidden ">
    <div class="flex flex-col gap-2">
        <div class="grid grid-cols-12 gap-2">
            <div class="col-span-12 l:col-span-6 l:px-4" id="anti_tetanus_section">
                <h2 class="l:text-lg text-gray-700 font-900 mb-2"> Anti-Tetanus Immunization</h2>
                <div class="grid grid-cols-6 ">
                    <div class="col-span-6 l:col-span-3 px-4">
                        <h2 class="text-xs l:text-l text-gray-500 font-900 mb-2">Year last Dose Given <br> <span class="text-gray-500 text-xs font-normal">( Leave blank if unknown )</span></h2>
                    ...
                    <div class="col-span-6 l:col-span-3">
                        <h2 class="text-xs l:text-l text-gray-500 font-900 mb-2">No. of Dose Given</h2>
                    ...
                    <div class="col-span-6 l:col-span-3 mt-2 l:px-4">
                        <h2 class="text-xs l:text-l text-gray-500 font-900 mb-2">Anti-Tetanus Vaccine</h2>
                    ...
                    <div class="col-span-6 l:col-span-1 mt-2 ">
                        <h2 class="text-xs l:text-l text-gray-500 font-900 mb-2">Dose <span class="font-normal">(ml)</span></h2>
                    ...
                    <div class="col-span-6 l:col-span-2 mt-2 l:px-4">
            ...
            <div class="col-span-12 l:col-span-6 l:px-4">
                <h2 class="l:text-lg text-gray-700 font-900 mb-2">Previous Anti-Rabies Immunization <span class="text-gray-500 text-xs font-normal">( Leave blank if N/A )</span></h2>
                <div class="grid grid-cols-6 ">
                    <div class="col-span-6 l:col-span-3">
                        <h2 class="text-xs l:text-l text-gray-500 font-900 mb-2">Immunization Type</h2>
                    ...
                    <div class="col-span-6 l:col-span-2">
                        <h2 class="text-xs l:text-l text-gray-500 font-900 mb-2">Date Given</h2>
                    ...
                    <div class="col-span-6 mt-2">
                        <h2 class="text-xs l:text-l text-gray-500 font-900 mb-2">Place Administered</h2>
            ...
            <div class="col-span-12  l:px-4">
                <h2 class="l:text-lg text-gray-700 font-900 mb-2">Current Anti-Rabies Immunization</h2>
                <div class="grid grid-cols-12 gap-2  ">
                    <!-- ACTIVE IMMUNIZATION SECTION  -->
                    <div class="col-span-12 l:col-span-4 items-center" id="active_section">
                        <h2 class="text-gray-500 font-900 ">Active Immunization</h2>
                        <div class="flex flex-col">
                            <h2>Post Exposure Prophylaxis (PEP)</h2>
                            <div class="flex flex-col">
                                <h2 class="text-xs l:text-l text-gray-500 font-900 mt-2">Administration Route</h2>
                                ...
                                <h2 class="text-xs l:text-l text-gray-500 font-900 ">Vaccine Type</h2>
                                ...
                                <div x-data="{ selectedCategory: 'PVRV' }" class="grid grid-cols-12">
                                    ...
                                    <!-- PVRV DROPDOWN  -->
                                    @props(['pvrvVaccines'])
                                    <div class="col-span-12 l:col-span-8 mt-2 " x-show="selectedCategory === 'PVRV'">
                                        <h2 class="text-xs l:text-l text-gray-500 font-900 mb-2">PVRV Vaccine</h2>
                                    ...
                                    <!-- PCEC DROPDOWN  -->
                                    @props(['pcecVaccines'])
                                    <div class="col-span-12 l:col-span-8 mt-2" x-show="selectedCategory === 'PCEC'">
                                        <h2 class="text-xs l:text-l text-gray-500 font-900 mb-2">PCEC Vaccine</h2>
                                        <div x-data="{ open: false, selected_pcec: null, selectedLabelPcec: 'Select Vaccine', volume: null }" class="relative">
                                            ...
                                            <div x-show="open"
                                                ...
                                                $formattedVolume = rtrim(rtrim(number_format($vaccine->remaining_volume, 2, '.', ''), '0'), '.');
                                                @endphp
                                                <div @click="selected_pcec = '{{ $vaccine->id }}'; selectedLabelPcec = '{{ $vaccine->batch_no }} - #{{ $vaccine->unit_number }}'; volume = '{{ $formattedVolume }}'; open = false"
                                                    class="px-3 py-2 cursor-pointer hover:bg-gray-100 text-sm">
                                                    {{ $vaccine->batch_no }} - #{{ $vaccine->unit_number }} - ({{ $formattedVolume }} ml)
                                                </div>
                                                @endforeach
                                    ...
                                    <div class="col-span-12 l:col-span-4 mt-2 l:px-4 ">
                                        <h2 class="text-xs l:text-l text-gray-500 font-900 mb-2">Dose <span class="font-normal">(ml)</span></h2>
                    ...
                    <div class="col-span-12 l:col-span-4" id="passive_section">
                        <h2 class="text-sm l:text-l  text-gray-500 font-900 mb-2">Passive Immunization <span class="text-gray-500 text-xs font-normal">( Skip if not needed )</span> </h2>
                        <div class="grid grid-cols-12" x-data="{ PassiveCategory: '' }">
                            <div class="col-span-12">
                                <h2 class=" text-xs l:text-l text-gray-500 font-900 ">RIG Type</h2>
                                <div class="flex  gap-4 p-2">
                                    <label class="flex items-center space-x-2">
                            ...
                            <!-- ERIG DROPDOWN  -->
                            @props(['erigVaccines'])
                            <div class="col-span-12 l:col-span-8 mt-2 " x-show="PassiveCategory === 'ERIG'">
                                <h2 class="text-xs l:text-l text-gray-500 font-900 mb-2">ERIG Vaccine</h2>
                                <div x-data="{ open: false, selected_erig: null, selectedLabelErig: 'Select Vaccine', volume: null }" class="relative">
                                    ...
                                    <div x-show="open"
                                        ...
                                        $formattedVolume = rtrim(rtrim(number_format($vaccine->remaining_volume, 2, '.', ''), '0'), '.');
                                        @endphp
                                        <div @click="selected_erig = '{{ $vaccine->id }}'; selectedLabelErig = '{{ $vaccine->batch_no }} - #{{ $vaccine->unit_number }}'; volume = '{{ $formattedVolume }}'; open = false"
                                            class="px-3 py-2 cursor-pointer hover:bg-gray-100 text-sm">
                                            {{ $vaccine->batch_no }} - #{{ $vaccine->unit_number }} - ({{ $formattedVolume }} ml)
                                        </div>
                                        @endforeach
                            ...
                            <!-- HRIG DROPDOWN  -->
                            @props(['hrigVaccines'])
                            <div class="col-span-12 l:col-span-8 mt-2 " x-show="PassiveCategory === 'HRIG'">
                                <h2 class="text-xs l:text-l text-gray-500 font-900 mb-2">HRIG Vaccine</h2>
                                <div x-data="{ open: false, selected_hrig: null, selectedLabelHrig: 'Select Vaccine' , volume: null }" class="relative">
                                    <!-- Hidden input to store the selected id -->
                                    <input type="hidden" name="hrig_vaccine_id" x-model="selected_hrig" :required="PassiveCategory === 'HRIG'"
                                        :disabled="PassiveCategory !== 'ERIG'">
                                    <!-- Button / Display -->
                                    <button type="button"
                                        @click="open = !open"
                                    ...
                                    <div x-show="open"
                                        ...
                                        $formattedVolume = rtrim(rtrim(number_format($vaccine->remaining_volume, 2, '.', ''), '0'), '.');
                                        @endphp
                                        <div @click="selected_hrig = '{{ $vaccine->id }}'; selectedLabelHrig = '{{ $vaccine->batch_no }} -  #{{ $vaccine->unit_number }} '; volume = '{{ $formattedVolume }}'; open = false"
                                            class="px-3 py-2 cursor-pointer hover:bg-gray-100 text-sm">
                                            {{ $vaccine->batch_no }} - #{{ $vaccine->unit_number }} ({{ $formattedVolume }} ml)
                                        </div>
                                        @endforeach
                    ...
                    <div class="col-span-12 l:col-span-4 flex flex-col items-center justify-center">
