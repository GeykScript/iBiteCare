                ...
                <div class="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12">
                    ...
                    <div class=" items-center">
                        <div class="flex flex-col">
                            <div class="flex flex-col">
                                <h2 class="text-xs md:text-md text-gray-500 font-900 mt-2 px-4">Administration Route</h2>
                        ...
                        <div class="flex gap-2 "
                            ...
                            <div class="flex flex-col ">
                                ...
                                <button
                                    ...
                                    type="button"
                                    :disabled="!nurse_id"
                                    @click="$dispatch('anti-tetanus-nurse-modal', { nurse_id: nurse_id, nurse_name: nurse_name })"
