            ...
            <div class="col-span-12 grid grid-cols-12 md:px-4 gap-4 md:gap-12">
                        ...
                        <div class="flex gap-2  justify-between"
                            ...
                            <div class="flex flex-col ">
                                ...
                                <button
                                    ...
                                    type="button"
                                    :disabled="!staff_id"
                                    @click="$dispatch('other-payment-modal', { staff_id: staff_id, staff_name: staff_name })"
                ...
                <div class="col-span-12 md:col-span-2 flex flex-col gap-2">
                    <div class="flex flex-col mt-6">
                        ...
                        @props(['services'])
                        <p class="text-sm text-gray-900">- {{ $services->name }}</p>
                        <div class="flex items-center">
                            <i data-lucide="philippine-peso" class="text-gray-900 w-4 h-4"></i>
                            <input type="text" id="display_service_fee" name="display_service_fee" disabled value="{{ $services->discounted_service_fee }}"
                                class="border-none text-gray-900 text-sm rounded-lg block w-full px-2">
                            <input type="hidden" id="service_fee" name="service_fee" disabled value="{{ $services->discounted_service_fee }}" required
                                class="border-none text-gray-900 text-sm rounded-lg block w-full px-2">
