                    ...
                    <div class="flex flex-col">
                        <div class="flex flex-col md:flex-row justify-between">
                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="flex  gap-4 p-2">
                                    <label class="flex items-center space-x-2">
                                        <input type="radio" name="immunization_type" value="Active" required
                                            class="text-red-500 focus:ring-red-500">
                                        <span>Active</span>
                                    </label>
                                    <label class="flex items-center space-x-2">
                        ...
                        <div class="grid grid-cols-6 ">
                            ...
                            <div class="col-span-6 md:col-span-3 mt-2 md:px-4">
                                ...
                                <p id="error_vaccine_id" class="text-red-500 text-xs mt-1 hidden">*This field is required</p>
                            </div>
                        ...
                        <div class="flex gap-2 "
                            ...
                            <div class="flex flex-col ">
                                ...
                                <button
                                    ...
                                    type="button"
                                    :disabled="!nurse_id"
                                    @click="$dispatch('other-nurse-modal', { nurse_id: nurse_id, nurse_name: nurse_name })"
...
<script>
    ...
    function dateOfTransactionToday() {
        const vaccineDate = document.getElementById("vaccine_date_dose_given");
        const today = new Date();
        const year = today.getFullYear();
        const month = String(today.getMonth() + 1).padStart(2, "0");
        const day = String(today.getDate()).padStart(2, "0");
        vaccineDate.value = `${year}-${month}-${day}`;
    }
