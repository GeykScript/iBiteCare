@props(['name' => 'password', 'id' => 'password', 'required' => false])
...
<div class="relative">
    <input
        ...
        {{ $required ? 'required' : '' }}
        {{ $attributes->merge([
            'class' => 'block mt-1 w-full py-2 text-lg bg-gray-100 border-gray-100 focus:border-gray-500 focus:bg-gray-50 focus:ring-gray-500 rounded-md shadow-sm'
        ]) }} />
