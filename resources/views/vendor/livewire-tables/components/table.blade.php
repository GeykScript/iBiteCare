...
@if ($isTailwind)
    <div
        ...
        {{ $attributes->merge($customAttributes['wrapper'])
            ->class([
                'shadow overflow-y-auto overflow-x-auto w-[18rem] md:w-full border-b border-gray-200 dark:border-gray-700 sm:rounded-lg' => $customAttributes['wrapper']['default'] ?? true
            ])
