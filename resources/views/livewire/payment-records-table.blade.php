        ...
        <table class="min-w-full  text-sm mt-2 ">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="border bg-gray-800 text-white px-2 py-2 hover:cursor-pointer" wire:click="setSortBy('transaction')">Service Received</th>
                    <th class="border bg-gray-800 text-white px-2 py-2">Invoice No#</th>
                    <th class="border bg-gray-800 text-white px-2 py-2">Receipt No#</th>
                    <th class="border bg-gray-800 text-white px-2 py-2 hover:cursor-pointer" wire:click="setSortBy('amount_paid')">Paid Amount</th>
                    <th class="border bg-gray-800 text-white px-2 py-2 hover:cursor-pointer" wire:click="setSortBy('payment_date')">Payment Date</th>
                    <th class="border-l border-b bg-gray-800 text-white px-2 py-2 ">Status</th>
                    <th colspan="2" class="px-2 py-2 border  bg-gray-800 text-white rounded-tr-lg  hover:cursor-pointer" wire:click="setSortBy('in_charge')"> In Charge</th>
                </tr>
            </thead>
            <tbody>
