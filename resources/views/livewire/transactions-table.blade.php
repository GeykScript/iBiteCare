        ...
        <table class="min-w-full  text-sm mt-2 ">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="border bg-gray-800 text-white px-2 py-2">Receipt Number</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border px-2 py-2 text-gray-700">{{ $transaction->paymentRecords->receipt_number }}</td>
